 ...
 * child's measured width). The height of ItemView can be anything; the The
 * purpose of this class is to optimize slide shuffle animations.
 */
public class DragSortItemView extends ViewGroup implements AnimationView {
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (mGravity == Gravity.TOP) {
            ...
            child.layout(0, getMeasuredHeight() - child.getMeasuredHeight(), getMeasuredWidth(),
                    getMeasuredHeight());
        }
    }
    ...
    public Animator getCustomAnimator() {
        ...
        return ((AnimationView) view).getCustomAnimator();
    }
